...
with tab_analisis:
    ...
    def make_exec_poster_png_v3(
        ...
        if trend_fig is not None:
            # render trend_fig into image and place
            buf = BytesIO()
