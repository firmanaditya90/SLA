...
# --------------------
# Password admin dari Secrets
# --------------------
ADMIN_PASSWORD = st.secrets["ADMIN_PASSWORD"]  # Simpan di Streamlit Secrets
password_input = st.sidebar.text_input("Masukkan password untuk upload data baru", type="password")
...
# --------------------
# Tombol reset data hanya untuk admin
# --------------------
...
periode_list = sorted(df_raw[periode_col].dropna().astype(str).unique().tolist(),
