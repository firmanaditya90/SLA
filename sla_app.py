...
# ==========================================================
#  SELA v7 — Natural Female Voice Data Copilot
  ...
  <div class="sela-root">
    <div class="head">
      <div class="brand">
        ...
        <div>
          <div class="title">SELA v8 • Virtual Human Voice</div>
          <div class="subtitle">Asisten virtual bergaya virtual human wanita yang membaca data aktif SLA Payment Analyzer, berbicara natural, dan memberi analisis otomatis secara elegan.</div>
        </div>
      </div>
      <div class="head-tags">
        <div class="tag">DATA CONNECTED</div>
        <div class="tag">VOICE READY</div>
        <div class="tag">VIRTUAL HUMAN</div>
      </div>
    </div>
          ...
          <div class="avatar-wrap">
            <div id="femaleAvatar" class="female-avatar">
              ...
              <div class="avatar-card">
                ...
                <div class="avatar-label"><strong>SELA • Virtual Human</strong>Asisten wanita digital yang siap berbicara, mendengarkan, dan menjelaskan insight SLA secara natural.</div>
              </div>
            </div>
          </div>
        </div>
