...
def make_exec_poster_png_v3(
    *,
    ...
    axES.text(0.00, 0.58, "Executive Score", fontsize=12, fontweight="bold", color=(0.02,0.08,0.16,0.95))
    axES.text(0.00, 0.10, f"Target KPI SLA: {_id_num(kpi_days,2,' hari')}", fontsize=10, color=(0.02,0.08,0.16,0.70), fontweight="bold")
